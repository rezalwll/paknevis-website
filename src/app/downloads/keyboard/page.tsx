            ...
            <div className="order-first md:order-none">
              ...
              >
                <Image
                  ...
                  priority
                  sizes=""
                  className="rotahte-180 object-contain scale-[1.3] pointer-events-none p;r-6 p;b-30"
                />
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            <SCard
              ...
              icon={
                <div className="h-10 w-10 rounded-xl border border-indigo-100 grid place-items-center bg-[#e5f0d9]">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm leading-7 text-gray-700">
          {[
            ...
            >
              <div className="text-xs text-indigo-700 font-medium bg-[#e5f0d9] border border-indigo-200 rounded-lg w-fit px-2 py-1 mb-3">
                قدم {b.step}
              </div>
